...
if (isset($_POST['loginBtn'])) {
    ...
    if ($user && password_verify($password, $user['password'])) { 
        ...
        header("Location: http://localhost/mycodes/job_application_login_search/index.php");
        exit;
    } else {
        // Invalid input
        $_SESSION['message'] = "Invalid login input. Please try again.";
        header("Location: http://localhost/mycodes/job_application_login_search/login.php");
        exit;
    }
}
...
if (isset($_POST['editApplicationBtn'])) {
    ...
    $query = updateApplication(
        $pdo, $_POST['username'], $_POST['first_name'], $_POST['last_name'], 
...
if (isset($_POST['deleteApplicationBtn'])) {
    ...
    $query = deleteApplication($pdo, $_GET['applicant_id']); // Ensure all variables are set
