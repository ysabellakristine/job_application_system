...
function updateApplication($pdo, $username, $first_name, $last_name, $gender, $email, $date_of_birth, $qualification, $contact_no, $application_status, $applicant_id, $user_id) {
    ...
    if ($executeQuery) {
        logAction($pdo, $user_id, 'UPDATE', "Updated application: $username");
        return true;
    }
...
function deleteApplication($pdo, $applicant_id) {
	$deleteToys = "DELETE FROM applicants WHERE applicant_id = ?";
